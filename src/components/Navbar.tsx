...
export default function Navbar() {
  ...
  return (
    <nav className="bg-background h-[98px] justify-center flex relative">
      {/* Navbar left buttons */}
      <div className="flex justify-between items-center w-full mx-[8%]">
        <div className="hidden md:flex space-x-12">
          {/* Styles for navBtn in index.css */}
          <a href="#" className="navBtn mr-[50px]">About Us</a>
          <a href="#" className="navBtn mr-[50px]">FAQs</a>
          <a href="#" className="navBtn">Contact Us</a>
        </div>
        {/* Wanlow image */}
        <img src="/images/Wanlow-Type-Logo-w-Tagline.webp" alt="Wanlow Logo" />
        ...
        <div className="hidden md:flex items-center space-x-8">
          <button className="group transition duration-300">
            <svg
              ...
              width="101.878" 
              height="22" 
              viewBox="0 0 101.878 22"
              className="fill-textPrimary transition duration-300 group-hover:fill-textPrimaryHover"
            >
              <text 
                ...
                font-weight="500"
              >
                <tspan x="0" y="0">Get Started</tspan>
              </text>

              <g transform="translate(89 1)">
                <g clip-path="url(#clip-path)">
                  <path d="M13.076,41c-1.922.512-3.913.755-5.853,1.191-.31.07-.77-.4-.35-.555,1.9-.7,3.869-1.006,5.817-1.524,1.7-.453,3.32-1.392,5.121-1.061.136.025.266.23.089.3A39.555,39.555,0,0,1,13.076,41" transform="translate(-5.109 -29.702)"/>
                  <path d="M4.612,3.732c-1.231,1.357-2.7,2.5-3.87,3.907-.211.253-.927.132-.7-.263a35.479,35.479,0,0,1,3.7-4.5C4.66,1.765,5.838.09,7.408,0c.161-.009.372.164.267.338A8.962,8.962,0,0,1,6.322,1.8c-.6.622-1.131,1.3-1.71,1.936" transform="translate(0 0)"/>
                  <path d="M8.754,66.621a32.636,32.636,0,0,0,4.692,1.54c.787.224,1.55.509,2.326.769a7.48,7.48,0,0,1,2.071.843c.228.167.059.393-.162.442-1.563.346-3.486-.595-4.972-1.017a19.44,19.44,0,0,1-2.4-.686,6.871,6.871,0,0,1-2.051-1.493c-.307-.28.266-.5.492-.4" transform="translate(-6.228 -50.742)"/>
                </g>
              </g>
            </svg>
          </button>

          <button className="group transition duration-300 ml-[50px]">
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              width="19.144" 
              height="32" 
              viewBox="0 0 19.144 32"
              className="fill-current text-textPrimary transition duration-300 group-hover:text-textPrimaryHover"
            >
              <g clip-path="url(#clip-path)">
                <path d="M23.208,5.5A6.354,6.354,0,0,0,20.082.92a6.507,6.507,0,0,0-6.664,0A6.575,6.575,0,0,0,10.5,5.71a6.108,6.108,0,0,0,1.389,4.512A5.61,5.61,0,0,0,13.856,11.6a5.916,5.916,0,0,0,2.38.445,7.591,7.591,0,0,0,3.755-.942,6.185,6.185,0,0,0,2.545-2.476A5.618,5.618,0,0,0,23.208,5.5M21.954,8.358a5.524,5.524,0,0,1-2.284,2.223,6.779,6.779,0,0,1-3.369.846,5.335,5.335,0,0,1-2.137-.4A5.06,5.06,0,0,1,12.4,9.791a5.476,5.476,0,0,1-1.247-4.05,5.9,5.9,0,0,1,2.616-4.3,5.844,5.844,0,0,1,5.983,0,5.71,5.71,0,0,1,2.8,4.111,5.037,5.037,0,0,1-.6,2.8" transform="translate(-7.902 0)" fill="currentColor"/>
        ...
        >
          ...
          <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M3 5h14a1 1 0 010 2H3a1 1 0 110-2zm14 4H3a1 1 0 100 2h14a1 1 0 100-2zm-14 4h14a1 1 0 010 2H3a1 1 0 110-2z" />
          </svg>
        </button>
      </div>
      ...
      <div className={`absolute top-full left-0 w-full bg-background flex flex-col space-y-4 p-5 px-[10%] shadow-md transition-transform duration-300 md:hidden z-20 ${isOpen ? "block" : "hidden"}`}>
        ...
        <button className="group transition duration-300">
          <svg
            ...
            className="fill-current text-textPrimary transition duration-300 group-hover:text-textPrimaryHover"
          >
            <text transform="translate(0 17)" font-size="16" font-family="Noto Sans Display" font-weight="500">
              <tspan x="0" y="0">Get Started</tspan>
            </text>
          </svg>
        </button>
